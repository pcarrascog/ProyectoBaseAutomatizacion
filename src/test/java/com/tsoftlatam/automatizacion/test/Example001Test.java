...
public class Example001Test extends AbstractTestObject {
	...
	public void a_validaPaginaIndex() {
		try {
			test = extent.startTest("a_validaPaginaIndex",
					"Este método debe validar la entrada la página index.html del sitio");
	...
	public void b_clickAdministrationInterface() {
		try {
			test = extent.startTest("b_clickAdministrationInterface",
	...
	public void c_clickLknBook() {
		try {
			test = extent.startTest("c_clickLknBook", "Este método debe direccionar hacia el link 'Book'");
	...
	public void d_seleccionarOpcionCmb() throws InterruptedException {
		try {
			test = extent.startTest("d_seleccionarOpcionCmb", "Seleccionar una opción del comboBox desplegado");
